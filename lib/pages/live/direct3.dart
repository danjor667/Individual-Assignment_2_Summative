...
class Direct3 extends StatefulWidget {
  const Direct3({Key? key}) : super(key: key);
...
class _Actualites extends State<Direct3> {
  ...
  void initState() {
    ...
    controller
      ...
      ..loadRequest(Uri.parse(
          'https://player.castr.com/live_9b0308c0d89811eebfb47d7ebfeb1c98'));
